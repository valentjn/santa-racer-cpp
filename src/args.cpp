...
void Santa::Args::check_args(int argc, char *argv[]) {
    ...
    for (i = 1; i < argc; i++) {
        ...
        if (arg == "--help") {
            ...
            Output::print("Source code: Copyright (C) 2010 Julian Valentin. "
                          "Licensed under GPL.\n"
            ...
            Output::print("This program is free software: you can "
              ...
              "License, or\n"
              "(at your option) any later version.\n\n");
            Output::print("This program is distributed in the hope that it "
              "will be useful,\n"
              ...
              "See the\n"
              "GNU General Public License for more details.\n\n");
            Output::print("You should have received a copy of the GNU General "
              "Public License\n"
