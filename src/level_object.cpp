...
void Santa::LevelObject::reinit(int tile_x, int tile_y, int gfx_index) {
    ...
    } else if ((gfx_index == 71) || (gfx_index == 72) ||
               (gfx_index == 73) || (gfx_index == 74) || (gfx_index == 76)) {
...
void Santa::LevelObject::hide(void) {
    m_hidden = true;
}
...
int Santa::LevelObject::get_tile_x(void) {
    return m_tile_x;
}

int Santa::LevelObject::get_tile_y(void) {
    return m_tile_y;
}

int Santa::LevelObject::get_width(void) {
    return m_width;
}

int Santa::LevelObject::get_height(void) {
    return m_height;
}

Santa::Mask *Santa::LevelObject::get_mask(void) {
    return m_mask;
}

bool Santa::LevelObject::exists(void) {
    return m_exists;
}

bool Santa::LevelObject::is_hidden(void) {
    return m_hidden;
}
...
Santa::Cloud *Santa::LevelObject::get_cloud(void) {
    return m_cloud;
}

Santa::Balloon *Santa::LevelObject::get_balloon(void) {
    return m_balloon;
}

Santa::Angel *Santa::LevelObject::get_angel(void) {
    return m_angel;
}

Santa::Goblin *Santa::LevelObject::get_goblin(void) {
    return m_goblin;
}
...
Santa::Snowman *Santa::LevelObject::get_snowman(void) {
    return m_snowman;
}

Santa::Finish *Santa::LevelObject::get_finish(void) {
    return m_finish;
}

SDL_Surface *Santa::LevelObject::get_surface(void) {
    return m_surface;
}
...
int Santa::LevelObject::get_frame_count(void) {
