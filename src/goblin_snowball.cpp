...
Santa::GoblinSnowball::GoblinSnowball(void *parent) {
    m_parent = parent;
}

Santa::GoblinSnowball::~GoblinSnowball(void) {
    return;
}
...
void Santa::GoblinSnowball::move(void) {
    return;
}
...
int Santa::GoblinSnowball::get_frame(void) {
    return 0;
}
